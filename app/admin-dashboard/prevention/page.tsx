...
export default function PreventionManagement() {
  ...
  const fetchTips = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/admin/fire-prevention/`, {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = editingTip
        ? `${process.env.NEXT_PUBLIC_API_URL}/api/admin/fire-prevention/${editingTip.id}/`
        : `${process.env.NEXT_PUBLIC_API_URL}/api/admin/fire-prevention/`;
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      const token = localStorage.getItem('access_token');
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/admin/fire-prevention/${id}/`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` },
      });
